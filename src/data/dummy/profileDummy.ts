...
export const exampleSocs = [docsoc, cgcu, kabaddiSoc, algoSoc, icEsports, droneSoc, sikhSoc, abacus, docsoc, cgcu, kabaddiSoc, algoSoc, icEsports, droneSoc, sikhSoc, abacus];

export const exampleInterests = ["Programming", "Computer Science", "Chess", "Video Games", "Baking", "Contact Sports", "Pubs", "Bars", "Kabaddi", "Drones", "Astronomy", "Space", "Theoretical Physics"]